...
namespace SP_ASPNET_1.DbFiles.UnitsOfWork
{
    public interface IUnitOfWork
    {
        ...
        IRepository<BlogPostReaction> BlogPostReactionRepository { get; }
    }
    public class UnitOfWork : IUnitOfWork, IDisposable
    {
        ...
        private IRepository<BlogPostReaction> _BlogPostReactionRepository;
        public IRepository<BlogPostReaction> BlogPostReactionRepository
        {
            get
            {
                if (this._BlogPostReactionRepository == null)
                {
                    this._BlogPostReactionRepository = new BlogPostReactionRepository(this._context);
                }
                return _BlogPostReactionRepository;
            }
        }
